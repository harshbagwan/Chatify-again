...
export const axiosInstance = axios.create({
  baseURL:
    import.meta.env.MODE === "development"
      ...
      : "/api", //"/api" sends the requeest to same domain as the frontend, which is the backend server in production. In development, it sends the request to localhost:000/api, where 000 is the port number of the backend server.
